...
import LionImg from "../assets/the lion.jpg";
import CrowImg from "../assets/crow.jpg";
import HareImg from "../assets/hare.webp";
import GreedyDogImg from "../assets/greedy.jpg";
import FriendsImg from "../assets/friends.jpg";
import SaveImg from "../assets/save.jpeg";
import BoyImg from "../assets/the boy.jpeg";
import GreedyHenImg from "../assets/greedyhen.webp";
...
export default function ShortStories() {
  const Stories = [
    ...
    },
    {
      ...
      text: `The Tortoise and the Hare. A hare mocked a slow tortoise. They raced; the hare slept on the way, and the tortoise won. Moral: Slow and steady wins the race.`,
    },
    {
      id: 4,
      ...
      content: (
        <>
          ...
          <p>
            ...
            His own bone fell into the water and was gone.
          </p>
          <p>
            <strong>Moral:</strong><br />
            Don’t be greedy.
      ...
      content: (
        <>
          ...
          <p>
            ...
            The animals were happy and became his friends.
          </p>
          <p>
            <strong>Moral:</strong><br />
    ...
    },
    {
      ...
      text: `The Ant and the Dove. An ant fell into the river. A dove dropped a leaf to save it. Later, the ant bit a hunter who tried to shoot the dove. The dove flew away safely. Moral: One good turn deserves another.`,
    },
    {
      id: 7,
    ...
    },
    {
      ...
      img: GreedyHenImg,
      videoUrl: "https://www.youtube.com/embed/IuiZM0kL1rg",
      content: (
        <>
          <h2>The Greedy Farmer</h2>
          <p>
      ...
      text: `The Greedy Farmer. A farmer had a hen that laid a golden egg daily. He wanted all the eggs at once. He killed the hen but found nothing. He lost everything. Moral: Greed is a curse.`,
    },
  ];
