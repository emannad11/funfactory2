...
content: (
  <>
    ...
    <p>
      ...
      - Different leaves or plants from around<br />
    ...
    <p>
      ...
      4. Try to identify the plants or name them yourself!
    </p>
  </>
),
text: `Plant Detective. You’ll need: Notebook and pencil, Magnifying glass (optional), Different leaves or plants from around, Labels or sticky notes. Instructions: Go outside and look for different kinds of plants. Observe leaf shapes, colors, and sizes carefully. Write or draw what you find in your notebook. Try to identify the plants or name them yourself!`,
    },
      {
       id: 5,
       title: "Hydroponic Growing Jar",
       img: "/src/assets/pb.jpg",
